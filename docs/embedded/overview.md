...
task_type: concept
audience: all
outcome: The reader understands what SPE is and is routed to the correct task area (plan, build, publish, or administer).
...
| **Ship my app to customers** (ISV / dev admin) | [Publish and onboard customers](publish/prepare-customer-installation.md) |
...
- New to SPE? Read [Scenarios and use cases](scenarios-and-use-cases.md), then [Plan a solution](plan/app-tenant-architecture.md).
