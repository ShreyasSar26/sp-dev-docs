...
slug: development__tutorials__doc-processing-acs
persona: developer
scenario_ids: [D12]
source_of_truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/tutorials/doc-processing-acs
...
**Agent task:** Answer SharePoint Embedded questions about "Document Processing with Azure Cognitive Services" using only this page. Use the exact Microsoft Graph calls, permissions, parameters, and steps below, respect the developer persona boundary, and cite this page.
...
You have already learned how to use webhooks with [the application](https://learn.microsoft.com/training/modules/sharepoint-embedded-create-app/) to get a notification whenever an existing file is updated, or a new file is uploaded in the [Using Webhooks tutorial](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/tutorials/using-webhooks). This tutorial will cover connecting it with Azure Cognitive Services to extract data from invoices.

To set up automatic AI processing with your current SharePoint application upon a change in your container, you need to follow [Using Webhooks](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/tutorials/using-webhooks) and then:
...
![document processing schema](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/Document-Processing.png)

> [!TIP]
> To learn more about the Microsoft Graph APIs used in this tutorial, see [Track changes for a Drive](https://learn.microsoft.com/graph/api/driveitem-delta), [Get a DriveItem resource](https://learn.microsoft.com/graph/api/driveitem-get), and [Upload or replace the contents of a DriveItem](https://learn.microsoft.com/graph/api/driveitem-put-content).
...
- [Quickstart: Create a multi-service resource for Azure AI services](https://learn.microsoft.com/azure/ai-services/multi-service-resource?tabs=windows&pivots=azportal)
- [Get started with Document Intelligence](https://learn.microsoft.com/azure/ai-services/document-intelligence/quickstarts/get-started-sdks-rest-api?view=doc-intel-3.1.0&viewFallbackFrom=form-recog-3.0.0&preserve-view=true&pivots=programming-language-javascript)
...
---
*Agent-first reformat of the official Microsoft Learn doc (content preserved). Source of truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/tutorials/doc-processing-acs*
