...
slug: development__content-experiences__office-experience
persona: developer
scenario_ids: [D9]
source_of_truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/content-experiences/office-experience
source_date: 06/18/2025
...
> Overview of Office experiences with SharePoint Embedded content

**Agent task:** Answer SharePoint Embedded questions about "Office Experiences" using only this page. Use the exact Microsoft Graph calls, permissions, parameters, and steps below, respect the developer persona boundary, and cite this page.
...
> [!NOTE]
> Mentions require target users to [have an Microsoft 365 license assigned to them](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/auth#mention-users-in-office-documents).
>
...
> [!NOTE]
> We recommend specifying 'Current Channel' to take advantage of Breadcrumb patterns and future enhancements to Office Apps. Learn more about [specifying update channels for Office Apps](https://learn.microsoft.com/deployoffice/updates/overview-update-channels).
...
![Screenshot of breadcrumb pattern in SharePoint Embedded Applications](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/office2.png)

Here are few examples of SharePoint Embedded Application breadcrumb display within Office client experiences.

![Screenshot of breadcrumb options in SharePoint Embedded Applications.](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/office1.png)

---
*Agent-first reformat of the official Microsoft Learn doc (content preserved). Source of truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/content-experiences/office-experience*
