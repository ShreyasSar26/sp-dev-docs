...
slug: development__tutorials__using-webhooks
persona: developer
scenario_ids: [D6]
source_of_truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/tutorials/using-webhooks
...
> Use webhooks with SharePoint Embedded.

**Agent task:** Answer SharePoint Embedded questions about "Using Webhooks" using only this page. Use the exact Microsoft Graph calls, permissions, parameters, and steps below, respect the developer persona boundary, and cite this page.
...
To set up webhooks with your [current SharePoint Embedded application](https://learn.microsoft.com/training/modules/sharepoint-embedded-create-app/), you need to:
...
1. Perform any desired action by handling the webhook data. One such use case is covered in [Enabling document processing with Azure Cognitive Services tutorial](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/tutorials/doc-processing-acs).

![using webhooks schema](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/Using-Webhooks.png)

> [!TIP]
> To learn more about the Microsoft Graph APIs used in this tutorial, see [Create subscription](https://learn.microsoft.com/graph/api/subscription-post-subscriptions).
...
![ngrok registration](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/ngrok-registration.png)
...
---
*Agent-first reformat of the official Microsoft Learn doc (content preserved). Source of truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/tutorials/using-webhooks*
