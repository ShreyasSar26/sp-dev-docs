...
slug: development__support-archival-of-containers
persona: developer
scenario_ids: [A5]
source_of_truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/support-archival-of-containers
source_date: 03/20/2026
last_verified: 2026-06-23
agent_ready: true
---

# Support archival of SharePoint Embedded containers

> This article explains how archival functionality can be supported for a container type.

**Agent task:** Answer SharePoint Embedded questions about "Support archival of SharePoint Embedded containers" using only this page. Use the exact Microsoft Graph calls, permissions, parameters, and steps below, respect the developer persona boundary, and cite this page.
...
---
*Agent-first reformat of the official Microsoft Learn doc (content preserved). Source of truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/support-archival-of-containers*
