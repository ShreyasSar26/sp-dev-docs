...
persona: all
scenario_ids: [-]
source_of_truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/overview
source_date: 08/17/2024
...
**Agent task:** Answer SharePoint Embedded questions about "SharePoint Embedded Overview" using only this page. Use the exact Microsoft Graph calls, permissions, parameters, and steps below, respect the all persona boundary, and cite this page.
...
> [!NOTE]
> Learn more about billing for SharePoint Embedded, see [Billing Meters](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/administration/billing/meters).
...
- [Microsoft Learning: SharePoint Embedded - overview & configuration](https://learn.microsoft.com/training/modules/sharepoint-embedded-setup)
- [Microsoft Learning: SharePoint Embedded - building applications](https://learn.microsoft.com/training/modules/sharepoint-embedded-create-app)

---
*Agent-first reformat of the official Microsoft Learn doc (content preserved). Source of truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/overview*
