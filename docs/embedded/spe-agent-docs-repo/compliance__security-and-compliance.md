...
slug: compliance__security-and-compliance
persona: admin
scenario_ids: [A8, A9, A10, D13, D14]
source_of_truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/compliance/security-and-compliance
source_date: 03/05/2025
...
> Details Security and Compliance methods provided by SharePoint Embedded

**Agent task:** Answer SharePoint Embedded questions about "Security and Compliance" using only this page. Use the exact Microsoft Graph calls, permissions, parameters, and steps below, respect the admin persona boundary, and cite this page.
...
For information on how to retrieve the `ContainerSiteURL` to set the various compliance policies described in this article at a container level, see [Get-SPOContainer](https://learn.microsoft.com/powershell/module/sharepoint-online/get-spocontainer).

### Audit

The Audit capabilities provided by SharePoint Embedded mirror the existing Audit functionalities currently supported within SharePoint. All user and admin operations performed in various applications hosted in SharePoint Embedded are captured, recorded, and retained in your organization's unified audit log. For more information on Audit, see [Auditing solutions in Microsoft Purview](https://learn.microsoft.com/purview/audit-solutions-overview).

For a detailed list of container type audit events, see [SharePoint Embedded audit log events](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/compliance/audit-events).
...
![Audit events](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/sc1.png)


### eDiscovery

Compliance Admins can use eDiscovery tools in Microsoft Purview to search/hold/export content hosted in the SharePoint Embedded platform. For more information on eDiscovery, see [Microsoft Purview eDiscovery solutions](https://learn.microsoft.com/purview/ediscovery).
...
![eDiscovery search](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/sc2.png)
...
![choose sites in eDiscovery search](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/sc3.png)

### Data Lifecycle Management (DLM)

SharePoint Embedded supports retention and holds policies on content stored in its applications using the Microsoft Purview compliance portal. For more information on DLM, see [Learn about Microsoft Purview Data Lifecycle Management](https://learn.microsoft.com/purview/data-lifecycle-management).
...
![retention policy](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/sc4.png)
...
![enforce retention policy](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/sc5.png)
...
Using Microsoft Purview, Admins can identify, monitor, and automatically protect sensitive items stored in applications using SharePoint Embedded. For more information on DLP, see  [Learn about data loss prevention](https://learn.microsoft.com/purview/dlp-learn-about-dlp).
...
![DLP Policy](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/sc6.png)
...
![Configure DLP Policy](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/sc7.png)
...
To learn more about setting sensitivity labels, see [Learn about sensitivity labels](https://learn.microsoft.com/purview/sensitivity-labels).
...
A SharePoint Advanced Management (SAM) license is needed to enforce this policy. Read the full documentation for advanced capabilities at [Block download policy for SharePoint sites and OneDrive](https://learn.microsoft.com/sharepoint/block-download-from-sites).
...
To learn more about conditional access policies, see [Control access from unmanaged devices](https://learn.microsoft.com/sharepoint/control-access-from-unmanaged-devices).

---
*Agent-first reformat of the official Microsoft Learn doc (content preserved). Source of truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/compliance/security-and-compliance*
