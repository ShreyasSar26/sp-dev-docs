...
slug: getting-started__spembedded-for-vscode
persona: developer
scenario_ids: [D2]
source_of_truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/getting-started/spembedded-for-vscode
source_date: 01/30/2024
...
> Installation and getting started with SharePoint Embedded for Visual Studio Code

**Agent task:** Answer SharePoint Embedded questions about "SharePoint Embedded for Visual Studio Code" using only this page. Use the exact Microsoft Graph calls, permissions, parameters, and steps below, respect the developer persona boundary, and cite this page.
...
![SharePoint Embedded VS Extensions](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/n1downloadvsx.png)

### Sign in with admin credentials

To use the extension, you must sign in to a Microsoft 365 tenant with an administrator account.

![Install](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/n2vsx-signin.png)

- Authentication opens a new tab in an external browser to grant permissions

    ![authorize and authenticate the extension to your M365 Entra tenant](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/auth-allow-extension-uri.png)

- Review the requested permissions carefully, then select **Accept** on the pop-up window prompting admin consent

    ![review before consenting to the permissions the extension is asking for](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/n3vsx-grant-admin-consent.png)

After successful authorization, select open on the dialog to be redirected to VS Code:

![authorization completed in browser now redirecting to visual studio code](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/auth-redirect.png)

## Create a container type with a trial configuration

Once signed in, you're prompted to create a [container type with trial configuration](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/getting-started/containertypes#trial-container-type). A container type lets you get started calling SharePoint Embedded APIs and building a proof-of-concept application using SharePoint Embedded. Learn more about [container types](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/getting-started/containertypes).

![home screen](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/n4vsx-home-screen.png)
...
![create container type](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/n5a-name-ct.png)
...
- Follow the prompts to name your new Entra application or select an existing application ID:
    ...
    ![Create App](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/n6aname-app.png)
...
After creating your container type, you'll need to register that container type on your local tenant. Learn more about container type [registration](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/getting-started/register-api-documentation).

- Follow the prompts and select **Register on local tenant** on the lower right corner of the VS Code window

    ![local tenant registration popup](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/local-tenant-registration-popup.png)
  
- If you don't see the prompt, you can right-click on your `<container-type-name>` and select **Register** from the menu

    ![register](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/n7aregister-ct.png)

### Grant permissions

Review permissions and follow the prompt to grant admin consent

![grant admin consent popup](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/auth-grant-admin-consent-popup.png)

An external browser window will pop open for you to sign-in and grant admin consent

![login permissions](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/n9alogin-grant-permissions.png)
...
![create container](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/n10acreate-container.png)
![name container](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/n11aname-first-cont.png)

## Recycling Containers

You can also recycle and recover containers within the extension.

![recycle containers](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/n12arecycle-cont.png)

![final home page](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/n13a-final-home-page.png)
...
![Load Sample App](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/n15vsxsa-c.png)
...
![sample app plain text secrets notice](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/sample-app-app-secrets-notice.png)

If no client secret is found on your application, it will ask if you would like to create one. Press OK to proceed.

![sample app creating client secret](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/sample-app-create-client-secret.png)
...
![function api console logs](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/fn-api-logs.png)

![client app console logs](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/client-app-logs.png)
...
![home-page-for-spe-sample-app](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/spe-sample-app-home.png)
...
![Export Postman Environment](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/vsx-images/n14postman-c.png)

---
*Agent-first reformat of the official Microsoft Learn doc (content preserved). Source of truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/getting-started/spembedded-for-vscode*
