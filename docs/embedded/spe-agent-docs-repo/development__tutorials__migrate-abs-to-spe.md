...
slug: development__tutorials__migrate-abs-to-spe
persona: developer
scenario_ids: [A5]
source_of_truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/tutorials/migrate-abs-to-spe
source_date: 08/02/2024
last_verified: 2026-06-23
agent_ready: true
---

# Tutorial to Migrate from Azure Blob Storage container to SharePoint Embedded container

> Tutorial in how to migrate from Azure Blob Storage container to SharePoint Embedded container Using C#

**Agent task:** Answer SharePoint Embedded questions about "Tutorial to Migrate from Azure Blob Storage container to SharePoint Embedded container" using only this page. Use the exact Microsoft Graph calls, permissions, parameters, and steps below, respect the developer persona boundary, and cite this page.
...
1. A Microsoft Entra ID application registration. See [register an application](https://learn.microsoft.com/graph/auth-register-app-v2).
1. Your Microsoft Entra ID tenant has a [Microsoft 365 subscription](https://learn.microsoft.com/training/m365/).
...
1. Azure Blob Storage container
    ...
    - For more information on how to set up an [ABS container](https://learn.microsoft.com/azure/storage/blobs/storage-blobs-introduction)
...
1. In the App Registration, add a new Mobile & Console application platform in [Microsoft Entra ID App Registration Authenticate portal](https://entra.microsoft.com)
    ...
    ![Screenshot of Microsoft Entra ID application configuration](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/app-registration-console-platform.png)
...
1.	After the build process is complete, you can run the application by executing the command **dotnet run** followed by the required arguments. The required arguments are:
    ...
    - The SPE container ID: This is the container you're migrating content to in the SPE. For more information on how to get the [container ID](https://learn.microsoft.com/graph/api/filestorage-list-containers)
...
- For more information about Blob Storage, see [Blob Storage documentation](https://learn.microsoft.com/azure/storage/blobs/storage-blobs-introduction).
...
---
*Agent-first reformat of the official Microsoft Learn doc (content preserved). Source of truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/tutorials/migrate-abs-to-spe*
