...
slug: graph-api/filestoragecontainer-list-recyclebinitem
persona: developer
scenario_ids: [D5]
source_of_truth: https://learn.microsoft.com/en-us/graph/api/filestoragecontainer-list-recyclebinitem?view=graph-rest-beta
...
> Get a list of recyclebinitem objects from a fileStorageContainer recycleBin.
...
If successful, this method returns a `200 OK` response code and a collection of [recycleBinItem](https://learn.microsoft.com/en-us/graph/api/resources/recyclebinitem?view=graph-rest-beta) objects in the response body.
...
---
*Agent-first reformat of the Microsoft Graph API reference (beta). Source of truth: https://learn.microsoft.com/en-us/graph/api/filestoragecontainer-list-recyclebinitem?view=graph-rest-beta*
