---
title: List columns
slug: graph-api/filestoragecontainer-list-columns
persona: developer
scenario_ids: [D4]
source_of_truth: https://learn.microsoft.com/en-us/graph/api/filestoragecontainer-list-columns?view=graph-rest-beta
...
> Get the collection of columns represented as columnDefinition resources in a fileStorageContainer.
...
Get the collection of columns represented as [columnDefinition](https://learn.microsoft.com/en-us/graph/api/resources/columndefinition?view=graph-rest-beta) resources in a  [fileStorageContainer](https://learn.microsoft.com/en-us/graph/api/resources/filestoragecontainer?view=graph-rest-beta).  
...
If successful, this method returns a `200 OK` response code and a collection of [columnDefinition](https://learn.microsoft.com/en-us/graph/api/resources/columndefinition?view=graph-rest-beta) objects in the response body.
...
---
*Agent-first reformat of the Microsoft Graph API reference (beta). Source of truth: https://learn.microsoft.com/en-us/graph/api/filestoragecontainer-list-columns?view=graph-rest-beta*
