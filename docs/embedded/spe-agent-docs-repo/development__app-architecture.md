...
slug: development__app-architecture
persona: developer
scenario_ids: [-]
source_of_truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/app-architecture
...
**Agent task:** Answer SharePoint Embedded questions about "App Architecture" using only this page. Use the exact Microsoft Graph calls, permissions, parameters, and steps below, respect the developer persona boundary, and cite this page.
...
![SharePoint Embedded Architecture](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/SPEArch.png)
...
![SPE multi app architecture](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/SPECTDedicated.png)
...
![SPE multi app architecture sharing Container Types](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/SPECTShared.png)
...
![Example](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/images/apparchexample.png)

---
*Agent-first reformat of the official Microsoft Learn doc (content preserved). Source of truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/app-architecture*
