...
slug: development__limits-calling
persona: developer
scenario_ids: [D3]
source_of_truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/limits-calling
source_date: 01/16/2026
...
**Agent task:** Answer SharePoint Embedded questions about "Limits and Calling Patterns" using only this page. Use the exact Microsoft Graph calls, permissions, parameters, and steps below, respect the developer persona boundary, and cite this page.
...
---
*Agent-first reformat of the official Microsoft Learn doc (content preserved). Source of truth: https://learn.microsoft.com/en-us/sharepoint/dev/embedded/development/limits-calling*
