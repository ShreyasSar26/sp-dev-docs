...
The launch tutorial shows a URL shape like this:
```http
...
To force a mode, update the query parameter as shown in the source tutorial:
```csharp
...
The Office source recommends specifying Current Channel to take advantage of breadcrumb patterns and future Office app enhancements.
